...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <!-- DIV UNTUK LEVEL MENU EDIT -->
        <div id="div-1" class="accordion-body collapse in body">
            <form action="level-menu-edit-save.php?id=<?php echo $var_levelid; ?>" method="post" class="form-horizontal">
                    <?php 
        $tampil     = "SELECT level_id, level_name FROM ref_level WHERE level_id='".$var_levelid."'";

...
<?php 
        if (isset($_POST['simpan'])) {
         ...
         $simpan = mysql_query("INSERT INTO ref_operator (operator_name, operator_gender, operator_username, operator_password, operator_login, operator_hint_question, operator_answer_question, level_id_fk) VALUES ('".$_POST['operator_name']."', '".$_POST['operator_gender']."', '".$_POST['operator_username']."', MD5('".$_POST['operator_password']."'), 'N', '".$_POST['operator_hint_question']."', '".$_POST['operator_answer_question']."', '".$_POST['level_id_fk']."')");
        if ($simpan) {
            echo "<script>alert ('Data berhasil disimpan'); location.href='index.php?hal=pengguna/list'</script>";
        }
        }
 ?>
<div id="content">

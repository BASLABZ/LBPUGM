...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form action="menu-add-save.php" method="post"class="form-horizontal">

                <div class="form-group"> 
                    <label class="control-label col-lg-4">Nama Menu</label>

                    <div class="col-lg-8">
                        <input type="text" placeholder="Nama Menu" class="form-control" name="frm_menu" required />
                    </div>
                </div>
                 <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" placeholder="Link Menu" class="form-control" name="frm_link"/>
                    </div>  
                </div>    
                <div class="form-group">
                    <label class="control-label col-lg-4">Menu Parent</label>
                        <div class="col-lg-8">
                            ...
                            <option>Tidak ada</option>
                               <?php     
                                    $select = "SELECT menu_id, menu_name, menu_url from ref_menu where menu_parent=0 order by menu_id ASC";
                                    $run = mysql_query($select);
                                    while ($runselect = mysql_fetch_array($run)) {
                                        $var_menuid    = $runselect['menu_id'];
                                        $var_menuname  = $runselect['menu_name'];?>

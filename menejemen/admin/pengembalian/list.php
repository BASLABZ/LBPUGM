            ...
            <div class="row" style="padding-top: 10px; padding-right: 10px; padding-left: 10px;">
                <div class="panel panel-primary" style="border-color: #1ab394;">
                    <div class="panel-heading">
                       <div class="row">
                            <div class="col-md-4">
                             <span class="fa fa-pencil"></span> Transaksi pengembalian Alat
                        </div>
                        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary" style="border-color: white;">
                        <div class="panel-heading">
                            <span class="fa fa-list"></span> Transaksi pengembalian Alat
                        </div>
                         ...
                         <table class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                                ...
                                                <?php 
                                                    ...
                                                    $querypengembalian = mysql_query("SELECT * FROM trx_loan_application a  JOIN tbl_member m on a.member_id_fk = m.member_id 
                                                        JOIN trx_payment_temp p ON p.loan_app_id_fk = a.loan_app_id
                                                        where p.payment_notif = 'VALID'   ORDER BY a.loan_app_id DESC");
                                                 ...
                                                 ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#detail_pengamnilan_alat" data-toggle='modal' data-id='<?php echo $ropengembalian_alat['loan_invoice']; ?>' class="btn btn-info dim_about"> <span class="fa fa-eye"></span> LIHAT DATA</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('#detail_pengamnilan_alat').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url : 'pengembalian/detail_pengembalian.php',
                data :  'id='+ rowid,

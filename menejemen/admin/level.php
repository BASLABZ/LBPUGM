...
<body class="padTop53 " >
    ...
    <div id="wrap">
       ...
       <div id="left">
            ...
            <div class="inner">
                ...
                <div class="col-lg-12">
                    <div class="form-group"> 
                             <a href="level-add.php" class="btn btn-primary" align="right"><i class="icon-plus"> Tambah Level</i></a></br>
                    </div>
        ...
        $var_check = "SELECT * from ref_level";
            ...
            //fetch array: mengambil data dr db
                ...
                ?> 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="level-edit.php?id=<?php  echo $var_id?>" class="btn btn-warning"><i class="icon-pencil icon-white"></i></a>
                        </td>
                        <td>
                            <a href="level-delete.php?id=<?php  echo $var_id?>" class="btn btn-danger"><i class="icon-trash icon-white"></i></a>
                        </td>
                        <?php
                        
                        //--dicheck apakah id_pangkat sudah ada di tabel level_menu
                        //--Jikalau sudah ada maka tulisannya edit fasilitas, 
                        //--jika belum ada tulisane isi fasilitas
                        $tampil ="SELECT level_id from ref_level_menu where level_id='".$var_id."'";
                        $sql    = mysql_query($tampil); 
                        $baris2 = mysql_num_rows($sql);

                        if($baris2==0){ // jika belum terisi
                            $kata="Isi"; // maka tulisan pada link berubah menjadi isi fasilitas 
                            ?>
                            <td>
                             <a href="level-menu-add.php?id=<?php  echo $var_id?>" class="btn btn-info"><?php echo $kata?> Fasilitas
                        </a></td> <?php
                        }
                        else // jika sudah
                        {
                            $kata="Edit"; //maka link berubah menjadi edit
                        }
                        ?>
                        <td>
                        <a href="level-menu-edit.php?id=<?php  echo $var_id?>" class="btn btn-info"><?php echo $kata?> Fasilitas
                        </a></td>
                        <!-- mengeluarkan link dan percabangan diatas - milik fasilitas -->
                </tr>       
            <?php
                }//while 
            ?>

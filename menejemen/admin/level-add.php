...
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            <form action="level-add-save.php" method="post"class="form-horizontal">

                <div class="form-group"> 
                    <label class="control-label col-lg-4">Nama Level</label>

                    <div class="col-lg-8">
                        <input type="text" placeholder="Nama Level" class="form-control" name="frm_level" required />
                    </div>
                </div>

                    ...
                    <div class="row">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php 
                                    $no = 0;
                                    $query_rekap_pembayaran = mysql_query("SELECT * FROM trx_loan_application p JOIN trx_payment_temp t ON t.loan_app_id_fk = p.loan_app_id where p.member_id_fk = '".$_SESSION['member_id']."'");

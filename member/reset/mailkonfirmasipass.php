...
<head>
    ...
    <title>LBPUGM-KONFIRMASI KE EMAIL</title>
       ...
       <div class="row">
           <div class="col-md-12" style="padding-top: 100px;">
                <div class="panel panel-primary">
                   ...
                   <center><a href="../../index.php"> <img src="../../img/logo-ugm.png" class="img-thumbnail"></a></center>
                   <br>
                    <div class="error-desc">
                        <button class="btn btn-primary"><span class="fa fa-home"></span> Silahkan Cek Email Untuk Reset Password Anda Anda !</button>
                    </div>
                </div>
                    </div>
                </div>
